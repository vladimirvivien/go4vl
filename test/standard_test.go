...
// TestIntegration_Standards consolidates all video standards tests under one
// parent function that opens the device once, avoiding "device or resource busy"
// errors from concurrent opens on v4l2loopback.
func TestIntegration_Standards(t *testing.T) {
	...
	t.Run("IndividualEnumerate", func(t *testing.T) {
	...
	t.Run("CommonGroupings", func(t *testing.T) {

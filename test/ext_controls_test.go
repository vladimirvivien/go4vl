...
// TestIntegration_ExtControls groups all extended control tests under one device open
func TestIntegration_ExtControls(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("GetExtControls", func(t *testing.T) {
	...
	t.Run("SetExtControls", func(t *testing.T) {
	...
	t.Run("TryExtControls", func(t *testing.T) {
	...
	t.Run("ExtControlsWithClass", func(t *testing.T) {
	...
	t.Run("ExtControlsMultiple", func(t *testing.T) {
	...
	t.Run("ExtControlsErrorHandling", func(t *testing.T) {
...
// TestIntegration_Events groups all event subscription tests under one device open
func TestIntegration_Events(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("SubscribeControlEvent", func(t *testing.T) {
	...
	t.Run("SubscribeAllEvents", func(t *testing.T) {
...
// TestIntegration_HighLevelControls groups all high-level control tests under one device open
func TestIntegration_HighLevelControls(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("HighLevelBrightness", func(t *testing.T) {
	...
	t.Run("HighLevelContrast", func(t *testing.T) {
	...
	t.Run("HighLevelSaturation", func(t *testing.T) {
	...
	t.Run("HighLevelHue", func(t *testing.T) {
		// Get current hue
	...
	t.Run("HighLevelMultipleControls", func(t *testing.T) {
		// Get original values

...
// TestIntegration_DVTimings groups all DV timing tests under one device open
func TestIntegration_DVTimings(t *testing.T) {
	...
	t.Run("EnumerateSpecific", func(t *testing.T) {
	...
	t.Run("StandardsAndFlags", func(t *testing.T) {
		timings, err := dev.GetDVTimings()
		if err != nil {
			t.Skip("Device does not support DV timings")
		}
	...
	t.Run("Polarities", func(t *testing.T) {
		timings, err := dev.GetDVTimings()
		if err != nil {
			t.Skip("Device does not support DV timings")
		}
	...
	t.Run("BlankingInfo", func(t *testing.T) {
		timings, err := dev.GetDVTimings()
		if err != nil {
			t.Skip("Device does not support DV timings")
		}

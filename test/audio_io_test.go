...
// TestIntegration_AudioInput groups all audio input tests under one device open
func TestIntegration_AudioInput(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("AudioInputEnumeration", func(t *testing.T) {
	...
	t.Run("AudioInputInfo", func(t *testing.T) {
	...
	t.Run("CurrentAudio", func(t *testing.T) {
	...
	t.Run("AudioSelection", func(t *testing.T) {
		// Get current audio
	...
	t.Run("AudioMode", func(t *testing.T) {
...
// TestIntegration_AudioOutput groups all audio output tests under one device open
func TestIntegration_AudioOutput(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("AudioOutputEnumeration", func(t *testing.T) {
	...
	t.Run("AudioOutputInfo", func(t *testing.T) {
	...
	t.Run("CurrentAudioOut", func(t *testing.T) {
	...
	t.Run("AudioOutputSelection", func(t *testing.T) {
	...
	t.Run("AudioOutMode", func(t *testing.T) {

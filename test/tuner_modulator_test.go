...
// TestIntegration_Tuner consolidates all tuner-related tests under one parent
// function that opens the device once, avoiding "device or resource busy" errors.
func TestIntegration_Tuner(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("TunerEnumeration", func(t *testing.T) {
		// Test GetAllTuners
	...
	t.Run("TunerInfo", func(t *testing.T) {
	...
	t.Run("FrequencyGet", func(t *testing.T) {
	...
	t.Run("FrequencySet", func(t *testing.T) {
		// First check if device has tuner
		tuners, err := dev.GetAllTuners()
		if err != nil || len(tuners) == 0 {
			t.Skip("Device does not have tuners")
	...
	t.Run("FrequencyBands", func(t *testing.T) {
		// First check if device has tuner
		tuners, err := dev.GetAllTuners()
		if err != nil || len(tuners) == 0 {
			t.Skip("Device does not have tuners")
	...
	t.Run("TunerSet", func(t *testing.T) {
		// First check if device has tuner
...
// TestIntegration_Modulator consolidates all modulator-related tests under one
// parent function that opens the device once.
func TestIntegration_Modulator(t *testing.T) {
	devPath := RequireV4L2Testing(t)
	dev := OpenDeviceOrSkip(t, devPath)

	t.Run("ModulatorEnumeration", func(t *testing.T) {
	...
	t.Run("ModulatorInfo", func(t *testing.T) {
	...
	t.Run("ModulatorSet", func(t *testing.T) {
